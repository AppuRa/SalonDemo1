...
<body>
	<form action="viewappointment" method="post">
		...
		<div>
			...
			<div id="dash" class="column-1-content">
				<img src="lo1.png" style="with: 18px; height: 18px"> <a
					href="viewappointment.jsp" class="column-1-text">Services</a>
			</div>
			<div id="dash" class="column-1-content">
		...
		<div>
			<div style="margin-left:70px;margin-top:120px">
				

					
						<div style="border:2px solid black"><h1>Ward Warren</h1></div>
						<br>
						<br>
						<div style="border:2px solid black"><h1>Jacob Jones</h1></div>
						<br>
						<br>
						<div style="border:2px solid black"><h1>Robert Fox</h1></div>
						<br>
