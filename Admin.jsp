...
<body>
	<form action="viewappointment" method="post">
		...
		<div>
			...
			<div id="dash" class="column-1-content">
				<img src="lo4.jpg" style="width: 18px; height: 18px"> <a
					href="viewappointment.jsp" class="column-1-text">Customers</a>
			</div>
			<div id="dash" class="column-1-content">
		...
		</aside> <section class="column-2"> <aside class="column-2-header">
		<b>Welcome to Habibi Salon</b> </aside> <section class="column-2-section-2">
		<aside class="column-2-section-2-card">Appointment</aside> <aside
			class="column-2-section-2-card">Services</aside> <aside
			class="column-2-section-2-card">Employee</aside> <aside
			class="column-2-section-2-card">Salary</aside> </section> </section> </section>
